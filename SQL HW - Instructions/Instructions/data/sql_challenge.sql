...
-- List the manager of each department with the following information: department #, department name, 
--the manager's employee # , last name, first name, and start and end employment dates.
SELECT
m.dept_no,
dept_name,
m.emp_no,
...
-- List the department of each employee with the following information: employee #, last name, first name, and department name
...
--including their employee #, last name, first name, and department name.
